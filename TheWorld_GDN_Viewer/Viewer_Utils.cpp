...
//		
//		{
//			TheWorld_Utils::GuardProfiler profiler(std::string("WorldDeploy 2.1.1.1 ") + __FUNCTION__, "MeshCacheBuffer::readVerticesFromMeshCache - readBufferFromMeshCache");
...
//
//		{
//			TheWorld_Utils::GuardProfiler profiler(std::string("WorldDeploy 2.1.1.2 ") + __FUNCTION__, "MeshCacheBuffer::readVerticesFromMeshCache - Loop popolamento array");
//
//			bool first = true;
//			int idx = 0;
//			while (movingStreamBuffer < endOfBuffer)
